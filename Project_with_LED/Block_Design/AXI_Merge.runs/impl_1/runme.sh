...
HD_PWD='C:/Users/marco/OneDrive/Desktop/Project - CopyOLD/Block_Design/AXI_Merge/AXI_Merge.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log AXI_Merge_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source AXI_Merge_wrapper.tcl -notrace
