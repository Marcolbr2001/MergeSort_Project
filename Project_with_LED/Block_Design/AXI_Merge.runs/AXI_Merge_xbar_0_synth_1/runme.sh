...
HD_PWD='C:/Users/marco/OneDrive/Desktop/Project - CopyOLD/Block_Design/AXI_Merge/AXI_Merge.runs/AXI_Merge_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AXI_Merge_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AXI_Merge_xbar_0.tcl
