...
HD_PWD='C:/Users/marco/OneDrive/Desktop/Project - CopyOLD/Block_Design/AXI_Merge/AXI_Merge.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AXI_Merge_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AXI_Merge_wrapper.tcl
