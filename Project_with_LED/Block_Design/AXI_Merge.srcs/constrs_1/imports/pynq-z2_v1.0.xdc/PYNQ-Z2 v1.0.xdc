...
set_property -dict { PACKAGE_PIN R14   IOSTANDARD LVCMOS33 } [get_ports { end_conversion_0 }]; #IO_L6N_T0_VREF_34 Sch=led[0]
...
#set_property -dict { PACKAGE_PIN D19   IOSTANDARD LVCMOS33 } [get_ports { Button_0 }]; #IO_L4P_T0_35 Sch=btn[0]
