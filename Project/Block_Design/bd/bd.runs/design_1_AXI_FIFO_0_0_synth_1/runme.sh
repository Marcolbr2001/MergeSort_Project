...
HD_PWD='C:/Users/lotto/Downloads/AXI_and_merge/AXI_and_merge/bd/bd/bd.runs/design_1_AXI_FIFO_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_AXI_FIFO_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_AXI_FIFO_0_0.tcl
