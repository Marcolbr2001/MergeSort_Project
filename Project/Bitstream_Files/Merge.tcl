...
#
# bd.tcl: Tcl script for re-creating project 'bd'
#
# Generated by Vivado on Sun Feb 11 13:19:38 +0100 2024
...
#
#    "C:/Users/lotto/Downloads/AXI_and_merge/AXI_and_merge/bd/bd/bd.srcs/sources_1/bd/design_1/design_1.bd"
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/../AXI_and_merge/bd/bd/bd.srcs/sources_1/bd/design_1/design_1.bd"]"\
  ]
  foreach ifile $files {
...
set orig_proj_dir "[file normalize "$origin_dir/../AXI_and_merge/bd/bd"]"
...
if { [get_property IS_LOCKED [ get_files -norecurse design_1.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/../AXI_and_merge/bd/bd/bd.gen/sources_1/bd/design_1/hdl/design_1_wrapper.vhd" ]
} else {
